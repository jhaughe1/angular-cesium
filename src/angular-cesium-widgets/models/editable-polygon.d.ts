...
export declare class EditablePolygon extends AcEntity {
    ...
    enableEdit: boolean;
    private createFromExisting(positions);
    setPointsManually(points: {
        position: Cartesian3;
        pointProps: PointProps;
    }[] | Cartesian3[], polygonProps?: PolygonProps): void;
    private addAllVirtualEditPoints();
    private setMiddleVirtualPoint(firstP, secondP);
    private updateMiddleVirtualPoint(virtualEditPoint, prevPoint, nextPoint);
    ...
    getHierarchy(): any;
    private removePosition(point);
    private updatePolygonsLayer();
    private updatePointsLayer(renderPolylines?, ...points);
    dispose(): void;
